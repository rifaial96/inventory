...
class FrontEndController extends JoshController
{
    ...
    public function postRegister(UserRequest $request)
    {
        ...
        try {
            // Register the user
            $user = Sentinel::register($request->only(['first_name', 'last_name', 'email', 'password', 'gender', 'client']), $activate);
            ...
            return Redirect("admin/")->with('success', trans('auth/message.signup.success'));

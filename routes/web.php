...
//        Route::post('{user}/passwordreset', 'UsersController@passwordreset')->name('passwordreset');
    ...
    Route::group(['prefix' => 'supplier'], function () {
        ...
        Route::get('{supplier}/delete', 'SupplierController@destroy')->name('supplier.delete');
        Route::get('{supplier}/confirm-delete', 'SupplierController@getModalDelete')->name('supplier.confirm-delete');
    });
    ...
    Route::group(['prefix' => 'customer'], function () {
        ...
        Route::get('{customer}/delete', 'CustomerController@destroy')->name('customer.delete');
        Route::get('{customer}/confirm-delete', 'CustomerController@getModalDelete')->name('customer.confirm-delete');
    });
    ...
    Route::get('product/barcode/{code}', 'ProductController@barcode');
    Route::post('product/print', 'ProductController@print');
    
    /*routes for Product Supplier*/
    Route::group(['prefix' => 'product_supplier'], function () {
        Route::get('data', 'ProductSupplierController@data')->name('product_supplier.data');
        Route::get('{product_supplier}/delete', 'ProductSupplierController@destroy')->name('product_supplier.delete');
        Route::get('{product_supplier}/confirm-delete', 'ProductSupplierController@getModalDelete')->name('product_supplier.confirm-delete');
    });
    Route::resource('product_supplier', 'ProductSupplierController');
    Route::get('product_supplier/create/{product_id}', 'ProductSupplierController@create');
    Route::get('product_supplier/delete/{id}', 'ProductSupplierController@destroy');

    /*routes for Sale*/
    Route::group(['prefix' => 'sale'], function () {
        Route::get('data', 'SaleController@data')->name('sale.data');
        Route::get('{sale}/delete', 'SaleController@destroy')->name('sale.delete');
        Route::get('{sale}/confirm-delete', 'SaleController@getModalDelete')->name('sale.confirm-delete');
        Route::get('{sale}/restore', 'SaleController@restore')->name('sale.restore');
    });
    Route::post('{sale}/save', 'SaleController@savePaid');
    Route::get('sale/completed/{id}', 'SaleController@completed');
    Route::resource('sale', 'SaleController');
    
    /*routes for Sale Detail*/
    Route::group(['prefix' => 'sale_detail'], function () {
        Route::get('data', 'SaleDetailController@data')->name('sale_detail.data');
        Route::get('{sale_detail}/delete', 'SaleDetailController@destroy')->name('sale_detail.delete');
        Route::get('{sale_detail}/confirm-delete', 'SaleDetailController@getModalDelete')->name('sale_detail.confirm-delete');
    });
    Route::resource('sale_detail', 'SaleDetailController');
    Route::get('sale_detail/create/{sale_id}', 'SaleDetailController@create');
    Route::get('sale_detail/delete/{id}', 'SaleDetailController@destroy');

    /*routes for Purchase*/
    Route::group(['prefix' => 'purchase'], function () {
        Route::get('data', 'PurchaseController@data')->name('purchase.data');
        Route::get('{purchase}/delete', 'PurchaseController@destroy')->name('purchase.delete');
        Route::get('{purchase}/confirm-delete', 'PurchaseController@getModalDelete')->name('purchase.confirm-delete');
        Route::get('{purchase}/restore', 'PurchaseController@restore')->name('purchase.restore');
    });
    Route::post('{purchase}/received', 'PurchaseController@received');
    Route::get('purchase/print/{id}', 'PurchaseController@print');
    Route::resource('purchase', 'PurchaseController');
    Route::get('report_purchase/', 'ReportPurchaseController@index');
    Route::get('report_purchase/search', 'ReportPurchaseController@search');
    Route::get('report_purchase/{id}', 'ReportPurchaseController@show');
    Route::get('report_purchase/print/{id}', 'ReportPurchaseController@print');
    
    /*routes for Purchase Detail*/
    Route::group(['prefix' => 'purchase_detail'], function () {
        Route::get('data', 'PurchaseDetailController@data')->name('purchase_detail.data');
        Route::get('{purchase_detail}/delete', 'PurchaseDetailController@destroy')->name('purchase_detail.delete');
        Route::get('{purchase_detail}/confirm-delete', 'PurchaseDetailController@getModalDelete')->name('purchase_detail.confirm-delete');
    });
    Route::resource('purchase_detail', 'PurchaseDetailController');
    Route::get('purchase_detail/create/{purchase_id}', 'PurchaseDetailController@create');
    Route::get('purchase_detail/delete/{id}', 'PurchaseDetailController@destroy');

    /*routes for Cash Flow*/
    Route::group(['prefix' => 'cash'], function () {
        Route::get('data', 'CashController@data')->name('cash.data');
        Route::get('{cash}/delete', 'CashController@destroy')->name('cash.delete');
        Route::get('{cash}/confirm-delete', 'CashController@getModalDelete')->name('cash.confirm-delete');
        Route::get('{cash}/restore', 'CashController@restore')->name('cash.restore');
    });
    ...
    Route::get('crop_demo', function () {
      ...
      //route for report sale
     Route::group(['prefix' => 'report_sale'], function () {
        Route::get('report_sale/', 'ReportSaleController@index');
        Route::get('{product}/delete', 'ProductController@destroy')->name('product.delete');
        Route::get('{product}/confirm-delete', 'ProductController@getModalDelete')->name('product.confirm-delete');
        Route::get('{product}/restore', 'ProductController@restore')->name('product.restore');
    });
      Route::get('report_sale/', 'ReportSaleController@index');
      Route::get('report_sale/search', 'ReportSaleController@search');
...
Route::get('/sale_detail/create/ajax-state',function()
{
    $state_id = Input::get("product_id");
    $categories = ProductSupplier::where('product_id','=',$state_id)->get();
    $subcategories=DB::table('suppliers')->select('suppliers.id','suppliers.company')->join('product_suppliers','product_suppliers.supplier_id','=','suppliers.id')->where('product_suppliers.product_id',$state_id)->get();

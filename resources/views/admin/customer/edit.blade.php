...
@section('content')
    <section class="content-header">
        <!--section starts-->
        <h1>@lang('customer/title.edit')</h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active">@lang('customer/title.edit')</li>
        </ol>
    </section>
    <!--section ends-->
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                {!! Form::model($customer, ['url' => URL::to('admin/customer/' . $customer->id), 'method' => 'put', 'class' => 'bf']) !!}
                <div class="row">
                    <div class="col-sm-8">
                        <label>Company</label>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-success blog_submit">@lang('customer/form.update')</button>
                            <a href="{{ URL::to('admin/customer') }}" class="btn btn-danger">@lang('customer/form.cancel')</a>
                        </div>
                    </div>
                    <!-- /.col-sm-4 --> </div>
                <!-- /.row -->

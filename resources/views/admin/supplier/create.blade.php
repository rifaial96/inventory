...
{{-- Page title --}}
@section('title')
    @lang('supplier/title.add-supplier') :: @parent
@stop
...
@section('content')
    <section class="content-header">
        <!--section starts-->
        <h1>@lang('supplier/title.add-supplier')</h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active">@lang('supplier/title.add-supplier')</li>
        </ol>
    </section>
    <!--section ends-->
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                {!! Form::open(array('url' => URL::to('admin/supplier'), 'method' => 'post', 'class' => 'bf')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group col-xs-12">
                            <button type="submit" class="btn btn-success">@lang('supplier/form.save')</button>
                            <a href="{!! URL::to('admin/supplier/create') !!}"
                               class="btn btn-danger">@lang('supplier/form.cancel')</a>
                        </div>
                    </div>
                    <!-- /.col-sm-4 --> </div>
                {!! Form::close() !!}

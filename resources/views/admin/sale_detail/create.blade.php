...
{{-- Page title --}}
@section('title')
    @lang('sale_detail/title.add-sale_detail') :: @parent
@stop
...
@section('content')
    <section class="content-header">
        <!--section starts-->
        <h1>@lang('sale_detail/title.add-sale_detail')</h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active">@lang('sale_detail/title.add-sale_detail')</li>
        </ol>
    </section>
    <!--section ends-->
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                {!! Form::open(array('url' => URL::to('admin/sale_detail'), 'method' => 'post', 'class' => 'bf')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group col-xs-12">
                            <button type="submit" class="btn btn-success">@lang('sale_detail/form.save')</button>
                            <a href="{!! URL::to('admin/sale/'.$sale_id) !!}"
                               class="btn btn-danger">@lang('sale_detail/form.cancel')</a>
                        </div>
                    </div>
                    <!-- /.col-sm-4 --> </div>
                {!! Form::close() !!}

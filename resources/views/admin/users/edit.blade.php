                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab2" disabled="disabled">
                                                ...
                                                <div class="form-group {{ $errors->first('company', 'has-error') }}">
                                                    <label for="dob" class="col-sm-2 control-label">Company Name</label>
                                                    <div class="col-sm-10">
                                                        <input id="cn" name="company" type="text" class="form-control"
                                                ...
                                                <div class="form-group {{ $errors->first('phone', 'has-error') }}">
                                                    <label for="dob" class="col-sm-2 control-label">Company Phone</label>
                                                    <div class="col-sm-10">

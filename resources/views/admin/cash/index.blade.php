...
@section('content')
    <section class="content-header">
        <h1>@lang('cash/title.cashlist')</h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li><a href="#">@lang('cash/title.cash')</a></li>
            <li class="active">@lang('cash/title.cashlist')</li>
        </ol>
    </section>
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ URL::to('admin/cash/create') }}" class="btn btn-sm btn-default"><span
